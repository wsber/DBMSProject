...
//
// PF_PageHandle: PFSuper page interface
//
class PF_PageHandle {
...
//
// PF_FileHandle: PFSuper File interface
//
class PF_BufferMgr;
...
//
// PF_Manager: provides PFSuper file management
//
class PF_Manager {
public:
...
//
// Print-error function and PFSuper return code defines
//
